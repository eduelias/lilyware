...
$GETH --unlock 0 --password password --datadir $DATADIR --nat none --networkid $NETWORKID --bootnodes leave-me-alone --rpc --identity lilymain --rpcaddr 0.0.0.0 --rpccorsdomain '*' --rpcport 8500 --etherbase $ETHERBASE console
